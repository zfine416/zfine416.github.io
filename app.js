...
$(function() {
    ...
    setElementWidth('.mini-white-circle');

    $.jInvertScroll(['#new-about'],        // an array containing the selector(s) for the elements you want to animate
        {
...
var setElementWidth = function(element) {
